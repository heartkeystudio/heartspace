...
/** @type {string} */
const CACHE_VERSION = '1783045248|3739497';
/** @type {string} */
const CACHE_PREFIX = 'HeartSpace-sw-cache-';
...
/** @type {string[]} */
const CACHEABLE_FILES = ["index.wasm","index.pck","index.side.wasm","liblexicon.web.template_release.wasm32.wasm"];
